...
const tag = computed(() => {
  const map: Record<string, string> = { HEADING_1: 'h1', HEADING_2: 'h2', HEADING_3: 'h3' }
...
const placeholder = computed(() => {
  const map: Record<string, string> = { HEADING_1: 'Heading 1', HEADING_2: 'Heading 2', HEADING_3: 'Heading 3' }
